...
public class CerebroCalculadoraED {
	...
	public static final int TAMANOHISTORIAL = 5;
	...
	public void operarRestaRes(Operaciones op) {
		infoOperacion(op);
		pedirUnNumero();
		this.resultado = this.resultado - this.numero2; //Aqui habia un + en vez de un - Lo he tenido que cambiar para que funcione el programa
		mostrarResultado(op);
		anadirHistorial(op);
	}
